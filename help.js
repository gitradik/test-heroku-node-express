const doorsQv = {
  // 2 type: ['classic', 'modern', 'hivde'], classic
  // 3 time: ['slow', 'fast'], slow
  // 4 adv: ['silent', 'normal'], silent
  // 5 modelType: ['01', '02', '03'], 01
  // 6 glass: [true, false], false 
  // 7 color: ['red', 'blue', 'yellow'] yellow
};
